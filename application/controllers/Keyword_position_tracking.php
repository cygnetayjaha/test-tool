...
class Keyword_position_tracking extends Home
{
    ...
    public function keyword_tracking_settings_action()
    {
        ...
        if($_POST) {
            ...
            $this->form_validation->set_rules('keyword', '<b>'.$this->lang->line("keyword").'</b>', 'trim|required');
            $this->form_validation->set_rules('website', '<b>'.$this->lang->line("website").'</b>', 'trim|required');
            $this->form_validation->set_rules('country', '<b>'.$this->lang->line("country").'</b>', 'trim|required');
