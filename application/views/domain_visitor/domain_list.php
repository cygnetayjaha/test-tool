...
<?php
    ...
    echo $this->session->flashdata('dashboard_msg');
    $view_permission    = 1;
...
<script type="text/javascript">       
    ...
    {               
        ...
        str+="<a title='"+more+"' style='cursor:pointer' class='btn btn-info' href='"+details_url+"'><i class='fa fa-binoculars'></i>"+more+"</a>";

        if(row.dashboard=='1') str+="&nbsp;&nbsp;&nbsp;&nbsp;<a style='cursor:pointer' class='btn btn-default' href='"+base_url+"domain_details_visitor/display_in_dashboard/"+row.id+"/0'><i class='fa fa-check'></i>"+"<?php echo $this->lang->line('remove from dashboard');?>"+"</a>";
        else str+="&nbsp;&nbsp;&nbsp;&nbsp;<a style='cursor:pointer' class='btn btn-primary' href='"+base_url+"domain_details_visitor/display_in_dashboard/"+row.id+"/1'><i class='fa fa-check'></i>"+"<?php echo $this->lang->line('show in dashboard');?>"+"</a>";

        if(delete_permission == 1){

            str=str+"&nbsp;&nbsp;&nbsp;&nbsp;<a style='cursor:pointer' title='"+delete_str+"' class='btn btn-danger' href='"+delete_url+"' onclick=\"return confirm('"+'<?php echo $this->lang->line("are you sure that you want to delete this record?"); ?>'+"')\" ><i class='fa fa-trash'></i> "+delete_str+"</a>";
    ...
    {
    	var str = '';
    	str = str+'<span class="label label-warning js_code" style="cursor:pointer" data="'+row.js_code+'"><?php echo $this->lang->line("get js code"); ?></sapn>';
    	return str;
    }
