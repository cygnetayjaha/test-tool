          ...
          <div class="box box-primary" style='border:10px solid #ccc'>
            ...
            <div class="box-footer clearfix no-border text-center">             
              ...
              <?php if($value['installed'] == '0'): ?>
                <a title="<?php echo $this->lang->line("activate"); ?>" class="btn btn-default btn-lg pull-left green activate_action" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/activate';?>"><i class="fa fa-check"></i> <?php echo $this->lang->line('activate');?></a>
              <?php endif; ?>

              <?php if($value['installed'] == '1'): ?>
                <a title="<?php echo $this->lang->line("deactivate"); ?>" class="btn btn-default btn-lg pull-left orange deactivate_action" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/deactivate';?>"><i class="fa fa-remove"></i> <?php echo $this->lang->line('deactivate');?></a>
              <?php endif; ?>
              <a title="<?php echo $this->lang->line("delete"); ?>" class="btn btn-default btn-lg pull-right red delete_action" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/delete';?>"><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete');?></a>
            </div>
          </div>
        </div>            
        <?php 
