	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1">			
			<div class="tabs-below">
				...
				<!-- Tab panes -->
				<div class="tab-content" style="background: #eee;padding:30px;border:1px solid #ccc;border-top:none;">					
					<?php $this->load->view('frontend_website_analysis/general'); ?>
					<?php  $this->load->view('frontend_website_analysis/alexa_info'); ?>				
					<?php  $this->load->view('frontend_website_analysis/similarweb_info'); ?>				
					<?php $this->load->view("frontend_website_analysis/social_network"); ?>
					<?php $this->load->view("frontend_website_analysis/meta_tag_info"); ?>
