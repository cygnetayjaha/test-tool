 ...
 public function _language_loader()
    ...
    */
    ...
    public function _site_viewcontroller($data=array())
    {
        ...
        $data["payment_package"]=$this->basic->get_data("package",$where=array("where"=>array("is_default"=>"0","price > "=>0,"validity >"=>0)),$select='',$join='',$limit=4,$start=NULL,$order_by='CAST(`price` AS SIGNED) asc' );
         $data["default_package"]=$this->basic->get_data("package",$where=array("where"=>array("is_default"=>"1","validity >"=>0,"price"=>"Trial")));

        //catcha for contact page

        $this->load->view('site/site_new_theme', $data);
    }
    ...
    */
    ...
    public function code_activation_check_action($purchase_code,$only_domain){
        ...
        if(1 == 1 ){
            ...
            $content_to_write['is_active'] = md5(md5('DEMO'));
    ...
    public function front_end_website_analysis()
    {
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  MOZ ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        // end of get moz info
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Mobile Friendly ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Backlink ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Alexa ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  SimilarWeb ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Facebook ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Pinterest ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Stumbleupon ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Buffer ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Google Index ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Reddit ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Xing ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Bing ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Yahoo ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Metatag ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Whois ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  IP ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Site's in same IP - ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        // $add_complete++;
        // $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        // $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Macafee ".$this->lang->line("step completed")."</div>";
        // $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Norton ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Google Safety ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        // $add_complete++;
        // $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        // $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  AVG ".$this->lang->line("step completed")."</div>";
        // $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
        ...
        $add_complete++;
        $this->session->set_userdata('website_analysis_complete_search', $add_complete);
        $website_analysis_completed_function_str .= "<div class='col-xs-12 col-md-6'> <i class='fa fa-check-circle green'></i>  Similar Site ".$this->lang->line("step completed")."</div>";
        $this->session->set_userdata('website_analysis_completed_function_str', $website_analysis_completed_function_str);
    ...
    public function front_ajax_get_social_network_data()
    {
        ...
        $domain_info['social_network_pieChart'] = array(
            ...
            6 => array(
                'value' => $infos[0]['stumbleupon_total_view'],
                'color' => '#82683B',
                'highlight' => '#82683B',
                'label' => 'Stumbleupon View'
                )
            );
        $domain_info['color_codes'] = "
                                        ...
                                        <li><i class='fa fa-circle-o' style='color:#82683B'></i> Stumbleupon View </li>
                                      ";
