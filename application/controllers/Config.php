    ...
    public function edit_config()
    {
        ...
        if ($_POST) 
        {
            ...
            else 
            {
                ...
                $virus_total_api=addslashes(strip_tags($this->input->post('virus_total_api', true)));

                $update_data=array("google_safety_api"=>$google_safety_api,"moz_access_id"=>$moz_access_id,"moz_secret_key"=>$moz_secret_key,"mobile_ready_api_key"=>$google_safety_api,"virus_total_api"=>$virus_total_api);
                $insert_data=array("google_safety_api"=>$google_safety_api,"moz_access_id"=>$moz_access_id,"moz_secret_key"=>$moz_secret_key,"mobile_ready_api_key"=>$google_safety_api,"virus_total_api"=>$virus_total_api,"user_id"=>$this->session->userdata("user_id"));
